defmodule AquiferWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AquiferWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AquiferWeb.Gettext, "errors", msg, opts)
    end
  end
